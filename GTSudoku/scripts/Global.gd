...
const AutoSaveFileName	= "user://GTSudoku_autosave.dat"		# 自動保存ファイル
const EnvFileName	= "user://GTSudoku_env.dat"				# 環境ファイル
const SettingsFileName	= "user://GTSudoku_stgs.dat"
const StatsFileName		= "user://GTSudoku_stats.dat"
const NSolvedFileName	= "user://GTSudoku_nSolved.dat"
const TodaysQuestFileName	= "user://GTSudoku_todaysQuest.dat"
